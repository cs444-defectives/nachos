...
class PendingInterrupt {
  public:
    PendingInterrupt(VoidFunctionPtr func, int param, long long unsigned time, IntType kind);
    ...
    long long unsigned when;			// When the interrupt is supposed to fire
...
class Interrupt {
  public:
	...
	int arg, long long unsigned when, IntType type);// at time ``when''.  This is called
